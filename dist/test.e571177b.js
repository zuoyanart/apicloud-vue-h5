...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/test.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $5d6a92 = exports.default || module.exports;
      
      if (typeof $5d6a92 === 'function') {
        $5d6a92 = $5d6a92.options;
      }
    
        /* template */
        Object.assign($5d6a92, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      ...
      _c("br"),
      _vm._v(" "),
      _c("van-button", { attrs: { type: "danger" }, on: { click: _vm.asd } }, [
        _vm._v("危险按钮")
      ])
    ],
    1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5d6a92', $5d6a92);
          } else {
            api.reload('$5d6a92', $5d6a92);
          }
        }
