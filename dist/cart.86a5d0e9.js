...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/cart.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $bd0e22 = exports.default || module.exports;
      
      if (typeof $bd0e22 === 'function') {
        $bd0e22 = $bd0e22.options;
      }
    
        /* template */
        Object.assign($bd0e22, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [_vm._v("购物车")])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bd0e22', $bd0e22);
          } else {
            api.reload('$bd0e22', $bd0e22);
          }
        }
